...
export type StorageHash =
  StorageHashBase<'11b6da80387686fd8551d14c20569a328a8bb7e40dd033d704c78c01ee9b819b'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly MessageImage: {
      ...
      readonly dataBase64: CodecTypes['pg/text@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly Order: {
      readonly id: CodecTypes['pg/text@1']['output'];
      ...
      readonly paymentStatus: 'PENDING' | 'SUBMITTED' | 'VERIFIED' | 'FAILED' | 'REFUNDED';
      ...
      readonly chatClosedAt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
      readonly problemReportedAt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly OrderItem: {
    ...
    readonly OrderMessage: {
      ...
      readonly senderUserId: CodecTypes['pg/text@1']['output'] | null;
      readonly body: CodecTypes['pg/text@1']['output'];
      readonly hasImage: CodecTypes['pg/bool@1']['output'];
      readonly sensitive: CodecTypes['pg/bool@1']['output'];
      readonly wipedAt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
    ...
    readonly SupportStatus: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly responseMinutes: CodecTypes['pg/int4@1']['output'];
      readonly awayUntil: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly User: {
      readonly id: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly MessageImage: {
      ...
      readonly dataBase64: CodecTypes['pg/text@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
    readonly Order: {
      readonly id: CodecTypes['pg/text@1']['input'];
      ...
      readonly chatClosedAt: CodecTypes['pg/timestamptz-temporal@1']['input'] | null;
      readonly problemReportedAt: CodecTypes['pg/timestamptz-temporal@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
    readonly OrderItem: {
    ...
    readonly OrderMessage: {
      ...
      readonly senderUserId: CodecTypes['pg/text@1']['input'] | null;
      readonly body: CodecTypes['pg/text@1']['input'];
      readonly hasImage: CodecTypes['pg/bool@1']['input'];
      readonly sensitive: CodecTypes['pg/bool@1']['input'];
      readonly wipedAt: CodecTypes['pg/timestamptz-temporal@1']['input'] | null;
    ...
    readonly SupportStatus: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly responseMinutes: CodecTypes['pg/int4@1']['input'];
      readonly awayUntil: CodecTypes['pg/timestamptz-temporal@1']['input'] | null;
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
    readonly User: {
      readonly id: CodecTypes['pg/text@1']['input'];
...
export namespace Models {
  export type public_User = {
    ...
    readonly [RelationKeys]?: 'accounts' | 'messages' | 'orders' | 'reviews' | 'sessions';
  };
  ...
  export type public_Order = {
    ...
    chatClosedAt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
    problemReportedAt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
  ...
  export type public_OrderMessage = {
    ...
    senderUserId: CodecTypes['pg/text@1']['output'] | null;
    body: CodecTypes['pg/text@1']['output'];
    hasImage: CodecTypes['pg/bool@1']['output'];
    sensitive: CodecTypes['pg/bool@1']['output'];
    wipedAt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
    readAt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    image: public_MessageImage | null;
    order: public_Order;
    sender: public_User | null;
    readonly [RelationKeys]?: 'image' | 'order' | 'sender';
  };
  export type public_MessageImage = {
    ...
    dataBase64: CodecTypes['pg/text@1']['output'] | null;
    createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
  ...
  export type public_SupportStatus = {
    id: CodecTypes['pg/text@1']['output'];
    responseMinutes: CodecTypes['pg/int4@1']['output'];
    awayUntil: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
    updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    readonly [RelationKeys]?: never;
  };
}
...
export declare const models: {
  public: {
    ...
    SupportStatus: Models.public_SupportStatus;
  };
};
      ...
      readonly public: {
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly order: {
              columns: {
                ...
                readonly chatClosedAt: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-temporal@1';
                  readonly nullable: true;
                };
                readonly problemReportedAt: {
                  readonly nativeType: 'timestamptz';
                  readonly codecId: 'pg/timestamptz-temporal@1';
                  readonly nullable: true;
                };
            ...
            readonly orderMessage: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'orderMessage_fromAdmin_readAt_idx_ae99dbe3';
                  readonly prefix: 'orderMessage_fromAdmin_readAt_idx';
                  readonly columns: readonly ['fromAdmin', 'readAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'orderMessage_sensitive_wipedAt_idx_2f4e2239';
                  readonly prefix: 'orderMessage_sensitive_wipedAt_idx';
                  readonly columns: readonly ['sensitive', 'wipedAt'];
                  readonly unique: false;
                },
                {
                ...
                {
                  readonly name: 'orderMessage_senderUserId_idx_64078a57';
                  readonly prefix: 'orderMessage_senderUserId_idx';
          ...
          readonly valueSet: {
            ...
            readonly PaymentStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['PENDING', 'SUBMITTED', 'VERIFIED', 'FAILED', 'REFUNDED'];
            };
            readonly ProductType: {
              readonly kind: 'valueSet';
      ...
      readonly public: {
        readonly models: {
          ...
          readonly Order: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly chatClosedAt: { readonly column: 'chatClosedAt' };
                readonly problemReportedAt: { readonly column: 'problemReportedAt' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
          ...
          readonly OrderMessage: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly sensitive: { readonly column: 'sensitive' };
                readonly wipedAt: { readonly column: 'wipedAt' };
          ...
          readonly SupportStatus: {
            ...
            readonly storage: {
              readonly table: 'supportStatus';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly responseMinutes: { readonly column: 'responseMinutes' };
                readonly awayUntil: { readonly column: 'awayUntil' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
          };
